    ...
    private List<Friend> ReadFromFile()
    {
      if (!File.Exists(StorageFile))
      {
        return new List<Friend>
                {
                    new Friend{Id=1,FirstName = "Thomas",LastName="Gautier",
                        Birthday = new DateTime(1980,10,28), IsDeveloper = true},
                    new Friend{Id=2,FirstName = "Julia",LastName="Michaux",
                        Birthday = new DateTime(1982,10,10)},
                    new Friend{Id=3,FirstName="Anna",LastName="Handels",
                        Birthday = new DateTime(2011,05,13)},
                    new Friend{Id=4,FirstName="Sara",LastName="Larsson",
                        Birthday = new DateTime(2013,02,25)},
                    new Friend{Id=5,FirstName = "Andreas",LastName="Bohler",
                        Birthday = new DateTime(1981,01,10), IsDeveloper = true},
                    new Friend{Id=6,FirstName="Lukas",LastName="Meier",
                        Birthday = new DateTime(1970,03,5), IsDeveloper = true},
                     new Friend{Id=7,FirstName="Charles",LastName="Heuberger",
                        Birthday = new DateTime(1987,07,16)},
                     new Friend{Id=8,FirstName="Erwin",LastName="Egin",
